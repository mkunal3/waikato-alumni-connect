          ...
          <div className="bg-white rounded-lg border p-8 mb-8" style={{ borderColor: 'var(--waikato-border)' }}>
            <div className="flex gap-8">
              ...
              <div className="flex-shrink-0">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1758875569897-5e214ccc4e17?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBtZW50b3IlMjBwb3J0cmFpdHxlbnwxfHx8fDE3NjQwNTEyODV8MA&ixlib=rb-4.1.0&q=80&w=1080"
