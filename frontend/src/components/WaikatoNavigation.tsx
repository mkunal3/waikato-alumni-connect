          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="px-3 py-2 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-all flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="px-4 py-2.5 rounded-xl text-white transition-all hover:shadow-lg flex items-center gap-2"
                  style={{ backgroundColor: '#D50000' }}>
                  <span className="text-sm font-medium">{t(content.nav.login.en, content.nav.login.mi)}</span>
